...
const messages = [
  "Chúc em ngày 8 tháng 3. Ngày càng xinh đẹp mặn mà dễ thương",
  "Như bông hoa đẹp toạ hương. Khiến anh say đắm vấn vương cõi lòng",
  "Chúc em luôn được thành công. Đứng trước nghịch cảnh cũng không đầu hàng",
  "Chúc em hạnh phúc ngập tràn. Luôn luôn vui vẻ bình an một đời",
  "Em là cô gái tuyền vời mà anh may mắn được trời ban cho",
  "Nên dù sướng khổ đói no hay là thử thách cam go thăng trầm.",
  "Thì anh vẫn mãi ở gần mãi là điểm tựa tinh thần bên em",
];
